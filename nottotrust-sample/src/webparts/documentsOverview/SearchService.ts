import { ISearchResults, ICells, ICellValue, ISearchResponse, IManagedMetadataValue } from './ISearchService';
import { SPHttpClient, SPHttpClientResponse } from '@microsoft/sp-http';
import { WebPartContext } from '@microsoft/sp-webpart-base';
import { ApplicationCustomizerContext } from '@microsoft/sp-application-base';

export default class SearchService {
  private _results: IManagedMetadataValue[];
  private static _instance: SearchService;

  constructor(private _context: WebPartContext | ApplicationCustomizerContext) {}

  /**
   * Get or initiate SearchService instance
   * @param ctx
   */
  public static getInstance(ctx?: WebPartContext | ApplicationCustomizerContext) {
    if (!SearchService._instance) {
      SearchService._instance = new SearchService(ctx);
    }
